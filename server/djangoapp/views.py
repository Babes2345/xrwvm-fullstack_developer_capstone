...
from .populate import initiate  # Ensure this is defined in your populate.py or relevant file
...
def get_dealer_reviews(request, dealer_id):
    ...
    return JsonResponse({'message': 'Invalid dealer ID'}, status=400)
...
def add_review(request):
    ...
    data = json.loads(request.body)
    post_review(data)
    return JsonResponse({'status': 'Review added'}, status=200)
